...
function TopCartButton() {
  ...
  return (
    <button
      ...
      className="relative flex h-8 w-8 items-center justify-center text-[#1C1B1B] transition-all hover:scale-110"
    ...
    >
      ...
      {cartCount > 0 ? (
        <span className="absolute right-0 top-0 flex h-[14px] min-w-[14px] items-center justify-center rounded-full bg-[#1C1B1B] px-1 text-center text-[8px] font-semibold leading-none text-white">
